    ...
    return (
        <>
            ...
            <main className="landing-page sidebar-collapse">
                <nav className={`navbar navbar-expand-lg fixed-top ${isTransparent ? 'navbar-transparent' : ''}`}
                     color-on-scroll="300">
                        ...
                        <div className="collapse navbar-collapse justify-content-end" id="navigation">
                            <ul className="navbar-nav">
                                <li className="nav-item">
                                    <Link href="/">
                                        <a className="nav-link">{isTransparent}BellaBot</a>
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link href="/ketty">
                                        <a className="nav-link">KettyBot</a>
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" rel="noreferrer" title="Follow us on Twitter"
                                       data-placement="bottom"
                                       href="https://twitter.com/servingrobot" target="_blank">
                                        <i className="fa fa-twitter"></i>
                                        <p className="d-lg-none">Twitter</p>
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" rel="noreferrer" title="Like us on Facebook"
                                       data-placement="bottom"
                                       href="https://m.facebook.com/profile.php?id=100075513878464" target="_blank">
                                        <i className="fa fa-facebook-square"></i>
                                        <p className="d-lg-none">Facebook</p>
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" rel="noreferrer" title="Follow us on Instagram"
                                       data-placement="bottom"
                                       href="https://www.instagram.com/servingrobot111/" target="_blank">
                                        <i className="fa fa-instagram"></i>
                                        <p className="d-lg-none">Instagram</p>
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <Link href={"tel:07716474334"}>
                                        <a className="nav-link">
                                            <i className="fa fa-phone" aria-hidden="true" style={{top: "2px"}}/>7716474334</a>
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link href="/contactus">
                                        <a className="btn btn-round btn-info">Contact US</a>
                                    </Link>
                                </li>
                            </ul>
                        </div>
